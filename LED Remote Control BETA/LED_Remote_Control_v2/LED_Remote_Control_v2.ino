...
int sFlag = 1; //flag for the current status | bsp. 1 for off
int btn;
...
void loop() {
  ...
  Serial.print("..");
  Serial.println(btnPressed(results.value));
  }
...
void case0()
{
  ...
  {
    int a = btnPressed(results.value);
    if(a < 17 && a > 0){
      sFlag = 1;
